...
- Precedes: e1 precedes e2 means that the ith occurrence of e1 arrives before the ith of e2
- Coincides: e1 coincides with e2 means that the ith occurrence of e1 arrives synchronously with the ith of e2
- Excludes: e1 excludes with e2 means that none of the occurrences of e1 arrives synchronously with one of e2
- DelayedFor: res = e1 DelayedFor N on e2 means that for each occurrences of e1 between two occurrences of e2, there is an occurrence of res after N occurrences of e2
