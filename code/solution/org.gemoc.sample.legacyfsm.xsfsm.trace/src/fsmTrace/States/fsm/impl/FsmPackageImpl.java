...
public class FsmPackageImpl extends EPackageImpl implements FsmPackage {
	 ...
	 * @generated
	 */
	private EClass tracedNumberVariableEClass = null;
	 ...
	 * @generated
	 */
	public EClass getTracedNumberVariable() {
		return tracedNumberVariableEClass;
	}
	 ...
	 * @generated
	 */
	public EReference getTracedNumberVariable_OriginalObject() {
		return (EReference)tracedNumberVariableEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getTracedNumberVariable_ValueSequence() {
		return (EReference)tracedNumberVariableEClass.getEStructuralFeatures().get(1);
	}
	...
	public void createPackageContents() {
		...
		tracedNumberVariableEClass = createEClass(TRACED_NUMBER_VARIABLE);
		createEReference(tracedNumberVariableEClass, TRACED_NUMBER_VARIABLE__ORIGINAL_OBJECT);
		createEReference(tracedNumberVariableEClass, TRACED_NUMBER_VARIABLE__VALUE_SEQUENCE);
	...
	public void initializePackageContents() {
		...
		tracedNumberVariableEClass.getESuperTypes().add(this.getTracedVariable());
		...
		initEClass(tracedNumberVariableEClass, TracedNumberVariable.class, "TracedNumberVariable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTracedNumberVariable_OriginalObject(), theFsmPackage_1.getNumberVariable(), null, "originalObject", null, 0, 1, TracedNumberVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getTracedNumberVariable_ValueSequence(), theStatesPackage.getNumberVariable_value_Value(), theStatesPackage.getNumberVariable_value_Value_Parent(), "valueSequence", null, 0, -1, TracedNumberVariable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
