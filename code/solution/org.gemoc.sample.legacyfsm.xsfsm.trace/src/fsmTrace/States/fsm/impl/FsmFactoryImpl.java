...
public class FsmFactoryImpl extends EFactoryImpl implements FsmFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case FsmPackage.TRACED_NUMBER_VARIABLE: return createTracedNumberVariable();
	 ...
	 * @generated
	 */
	public TracedNumberVariable createTracedNumberVariable() {
		TracedNumberVariableImpl tracedNumberVariable = new TracedNumberVariableImpl();
		return tracedNumberVariable;
	}
