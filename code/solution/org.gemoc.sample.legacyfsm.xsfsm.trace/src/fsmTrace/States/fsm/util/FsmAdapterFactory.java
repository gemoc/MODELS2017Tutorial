...
public class FsmAdapterFactory extends AdapterFactoryImpl {
	...
	protected FsmSwitch<Adapter> modelSwitch =
		new FsmSwitch<Adapter>() {
			...
			@Override
			public Adapter caseTracedNumberVariable(TracedNumberVariable object) {
				return createTracedNumberVariableAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.States.fsm.TracedNumberVariable <em>Traced Number Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createTracedNumberVariableAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link fsmTrace.States.fsm.TracedVariable <em>Traced Variable</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
