...
public interface FsmFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Traced Number Variable</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Traced Number Variable</em>'.
	 * @generated
	 */
	TracedNumberVariable createTracedNumberVariable();
