...
public class FsmSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FsmPackage.ASSIGN_VALUE_ACTION: {
				AssignValueAction assignValueAction = (AssignValueAction)theEObject;
				T result = caseAssignValueAction(assignValueAction);
				if (result == null) result = caseAction(assignValueAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case FsmPackage.INCREASE_VALUE_ACTION: {
				IncreaseValueAction increaseValueAction = (IncreaseValueAction)theEObject;
				T result = caseIncreaseValueAction(increaseValueAction);
				if (result == null) result = caseAction(increaseValueAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FsmPackage.DECREASE_VALUE_ACTION: {
				DecreaseValueAction decreaseValueAction = (DecreaseValueAction)theEObject;
				T result = caseDecreaseValueAction(decreaseValueAction);
				if (result == null) result = caseAction(decreaseValueAction);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Assign Value Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Assign Value Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAssignValueAction(AssignValueAction object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Increase Value Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Increase Value Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseIncreaseValueAction(IncreaseValueAction object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Decrease Value Action</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Decrease Value Action</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseDecreaseValueAction(DecreaseValueAction object) {
		return null;
	}
