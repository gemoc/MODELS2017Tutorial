...
/**
 * This is the item provider adapter for a {@link org.gemoc.models17.fsm.xfsm.model.Transition} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_tgt_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_tgt_feature", "_UI_Transition_type"),
				 ModelPackage.Literals.TRANSITION__TGT,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.TRANSITION__SRC,
				 true,
				 false,
				 true,
				 null,
