...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see org.gemoc.models17.fsm.xfsm.model.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(fsmEClass, org.gemoc.models17.fsm.xfsm.model.FSM.class, "FSM", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getFSM_Name(), ecorePackage.getEString(), "name", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_OwnedStates(), this.getState(), this.getState_Fsm(), "ownedStates", null, 0, -1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_OwnedTransitions(), this.getTransition(), this.getTransition_Fsm(), "ownedTransitions", null, 0, -1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_InputBuffer(), this.getBuffer(), this.getBuffer_OutgoingFSM(), "inputBuffer", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_OutputBuffer(), this.getBuffer(), this.getBuffer_IncomingFSM(), "outputBuffer", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_InitialState(), this.getState(), null, "initialState", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getFSM_CurrentState(), this.getState(), null, "currentState", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSM_UnderProcessTrigger(), ecorePackage.getEString(), "underProcessTrigger", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSM_ConsummedString(), ecorePackage.getEString(), "consummedString", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getFSM_ProducedString(), ecorePackage.getEString(), "producedString", null, 0, 1, org.gemoc.models17.fsm.xfsm.model.FSM.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEClass(systemEClass, org.gemoc.models17.fsm.xfsm.model.System.class, "System", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getSystem_OwnedFsms(), this.getFSM(), null, "ownedFsms", null, 0, -1, org.gemoc.models17.fsm.xfsm.model.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSystem_OwnedBuffers(), this.getBuffer(), null, "ownedBuffers", null, 0, -1, org.gemoc.models17.fsm.xfsm.model.System.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
