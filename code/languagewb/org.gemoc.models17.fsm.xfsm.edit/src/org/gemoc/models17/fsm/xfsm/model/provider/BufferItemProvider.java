...
/**
 * This is the item provider adapter for a {@link org.gemoc.models17.fsm.xfsm.model.Buffer} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BufferItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOutgoingFSMPropertyDescriptor(object);
			addIncomingFSMPropertyDescriptor(object);
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.BUFFER__INITIAL_VALUE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Outgoing FSM feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOutgoingFSMPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Buffer_outgoingFSM_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Buffer_outgoingFSM_feature", "_UI_Buffer_type"),
				 ModelPackage.Literals.BUFFER__OUTGOING_FSM,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Incoming FSM feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addIncomingFSMPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Buffer_incomingFSM_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Buffer_incomingFSM_feature", "_UI_Buffer_type"),
				 ModelPackage.Literals.BUFFER__INCOMING_FSM,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ModelPackage.Literals.BUFFER__CURRENT_VALUES,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
